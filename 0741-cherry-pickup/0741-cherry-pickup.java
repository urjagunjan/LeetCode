class Solution {
    private Integer[][][][] dp;
    private int solver(int[][] grid,int r1,int c1,int r2){
        int c2=r1+c1-r2;
        ...
        int rightright=solver(grid,r1,c1+1,r2);
        int rightdown=solver(grid,r1,c1+1,r2+1);
        int downdown=solver(grid,r1+1,c1,r2+1);
        int downright=solver(grid,r1+1,c1,r2);
